 ...
 */
@Embeddable
public class AdminMotherTreePK implements Serializable {
    ...
    public AdminMotherTreePK() {
    }

    public AdminMotherTreePK(String adminID, String familyTreeID) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AdminMotherTreePK)) {
            return false;
        }
        AdminMotherTreePK other = (AdminMotherTreePK) object;
    ...
    public String toString() {
        return "mainEntities.AdminMotherTreePK[ adminID=" + adminID + ", familyTreeID=" + familyTreeID + " ]";
    }
